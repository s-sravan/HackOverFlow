...
class Question Extends OneClass {
	...
	public static $db_fields = array( "id" , "user_id" , "title" , "feed",  "tags", "content", "likes", "dislikes", "answers" , "views" ,"shares", "follows" , "slug", "created_at" , "updated_at" , "published" , "anonymous" , "item_type", "space_id");
	...
	public static function get_tagcloud($data) {
		global $db;
		$result = $db->query("SELECT GROUP_CONCAT(feed SEPARATOR ',') AS tagcloud FROM questions WHERE space_id = 0 group by 'all' ");
