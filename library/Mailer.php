<?php
require_once(LIBRARY_PATH."mail_template/class.phpmailer.php");
require_once(LIBRARY_PATH."mail_template/class.pop3.php");
require_once(LIBRARY_PATH."mail_template/class.smtp.php");
require_once(LIBRARY_PATH."mail_template/phpmailer.lang-en.php");
...
class Mailer {
		...
		$body = file_get_contents(LIBRARY_PATH.'mail_template/template1.html');
